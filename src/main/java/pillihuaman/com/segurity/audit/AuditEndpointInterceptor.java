package pillihuaman.com.segurity.audit;
...
@Component
public class AuditEndpointInterceptor extends WebRequestHandlerInterceptorAdapter {
	...
	public AuditEndpointInterceptor(WebRequestInterceptor requestInterceptor) {
